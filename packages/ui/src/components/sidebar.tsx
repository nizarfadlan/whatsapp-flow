...
import {
	...
	TooltipContent,
	TooltipTrigger,
} from "@whatsapp-flow/ui/components/tooltip";
import { useIsMobile } from "@whatsapp-flow/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: shadcn registry pattern
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: shadcn registry pattern
